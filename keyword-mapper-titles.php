...
try {
    ...
    SELECT submissions.submission_id as submission_id, publication_settings.setting_value FROM publication_settings 
    ...
    while ($article = $newDbPublications->fetch_assoc()) {
        ...
        if ($bestMatch && $bestSimilarity >= 70) { // 70% similarity threshold
            ...
            echo "New Title: $articleTitle (ID: $submissionId)\n";
